...
namespace Cadastro.Business.Models.Validations.Documentos
{
    ...
    public class InscricaoEstadualValidacao
    {
        public static bool Validar(string uf, string inscricao)
        {
            string exePath = @"C:\ProjetoTikano\tikano-backend\src\Cadastro.Extern\bin\x86\Debug\net6.0\Cadastro.Extern.exe"; // Substitua pelo caminho do seu arquivo .exe
            string output;

            string[] arguments1 = new string[3];
            arguments1[0] = "INSCRICAO_ESTADUAL";
            arguments1[1] = uf;
            arguments1[2] = inscricao;
            bool result = false;
            ...
            try
            {
                using (var process = new Process())
                {
                    ...
                    process.StartInfo.Arguments = string.Join(" ", arguments1);
